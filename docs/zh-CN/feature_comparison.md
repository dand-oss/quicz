...
更新时间：2026-08-11。来源：各项目 README、源码审查、RFC 合规追踪。
...
| X25519 ECDH | 8446 | ✅ | ✅ | ✅ | ✅ | — |
| X25519Kyber768（后量子） | draft | ✅ | ✅ | ✅ | ⚠️ | 独立 KEM 原语（pq_kex.zig），未接入 TLS 1.3 握手 |
...
| 拥塞控制（7 项） | 5/7 | 5/7 | 6/7 | 7/7 |
| 密码套件（5 项） | 5/5 | 5/5 | 5/5 | 4/5 |
| 应用层（6 项） | 6/6 | 3/6 | 0/6 | 6/6 |
| 平台（3 项） | 2/3 | 0/3 | 1/3 | 1/3 |
| **合计（40 项）** | **37/40** | **27/40** | **26/40** | **38/40** |
...
2. X25519Kyber768 — 独立 KEM 原语（pq_kex.zig）；尚未接入 TLS 1.3 握手
